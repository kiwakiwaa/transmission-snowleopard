...
These notes cover the shared compatibility build flow for Mac OS X 10.7 through macOS 10.13. Mac OS X 10.6 has a separate [Snow Leopard build guide](macOS-10.6.md) because it needs ARC-lite setup.

## Targets

- [OS X 10.7 Lion](#mac-os-x-107-lion)
- [OS X 10.8 Mountain Lion](#os-x-108-mountain-lion)
- [OS X 10.9 Mavericks](#os-x-109-mavericks)
- [OS X 10.10 Yosemite](#os-x-1010-yosemite)
- [macOS 10.13 High Sierra](#macos-1013-high-sierra)
