...
Testing on OS X 10.7 Lion, OS X 10.9 Mavericks, and OS X 10.10 Yosemite is planned as compatibility coverage grows.
...
<img src="docs/images/screenshot-main-window.png" alt="Transmission main window on Snow Leopard" width="480">
